...
class WhittedNoShadowIntegrator : public Integrator {
public:
	WhittedNoShadowIntegrator(const PropertyList &props)
	{
	}
	...
	std::string toString() const {
		return "WhittedNoShadowIntegrator[]";
	}

	EIntegratorType getIntegratorType() const
	{
		return EIntegratorType::EWhittedNoShadows;
	}
...
NORI_REGISTER_CLASS(WhittedNoShadowIntegrator, "whittedNoShadow");
NORI_NAMESPACE_END